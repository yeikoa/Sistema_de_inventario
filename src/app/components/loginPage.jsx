...
export  function LoginPage() {//hook local
    const [username, setUsername ] = useState ('');
    const [password, setPassword] = useState ('');

    const handleLogin = () =>{ //Para enviar los datos a la base de datos
    ...
    return(
        ...
        <div className="w-full max-w-md p-6 bg-gray-300 rounded-lg shadow-md transform transition-all duration-300 hover:scale-105">
          ...
          <div className="mt-4 text-center">
            <p className="text-teal-600">¿No tienes una cuenta? <a href="#" className="text-green-700">Regístrate aquí</a></p>
          </div>
        </div>
      </div>
    );
