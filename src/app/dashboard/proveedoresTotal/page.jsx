...
export default function Provider() {
  ...
  const showEditConfirmation = (provider) => {
    ...
    Swal.fire({
      ...
      text: `Confirma si deseas ${
        isEditing ? "guardar los cambios" : "editar"
      }.`,
      icon: "question",
  ...
  const handleEdit = (provider) => {
    ...
    if (editedProvidersCopy[provider.proveedor_id]) {
      ...
      axios
        .put(`/api/proveedores/${provider.proveedor_id}`, updatedProvider)
        .then((response) => {
          //console.log("Respuesta de actualización:", response.data);
          // Actualizar el estado de providers si es necesario
          const updatedProviders = providers.map((p) =>
            p.proveedor_id === provider.proveedor_id
              ? { ...p, ...updatedProvider }
              : p
          );
          ...
          axios
            .post(`/api/movimientos/proveedores`, providerData)
            .then((response) => {
        ...
        {providers
          ...
          .map((row) => (
            <div
              ...
              className="border border-gray-300 p-4 rounded-md shadow-md w-full bg-cyan-950 hover:bg-cyan-800 transition duration-300 ease-in-out"
            >
              <div>
                    ...
                    <div className="flex flex-wrap -mx-2 mb-2">
                      ...
                      <div className="w-1/2 px-2">
                        ...
                        <input
                          ...
                          type="text"
                          value={
                            editedProviders[row.proveedor_id].vendedor || ""
                          }
                          onChange={(e) =>
                            handleInputChange(e, "vendedor", row)
                          }
                          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                      </div>
                    ...
                    <div className="flex flex-wrap -mx-2 mb-2">
                      ...
                      <div className="w-1/2 px-2">
                        ...
                        <input
                          ...
                          type="text"
                          value={
                            editedProviders[row.proveedor_id].telefono || ""
                          }
                          onChange={(e) =>
                            handleInputChange(e, "telefono", row)
                          }
                          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                      </div>
                    ...
                    <div className="flex flex-wrap -mx-2">
                      <div className="w-full px-2">
                        ...
                        <input
                          ...
                          type="text"
                          value={
                            editedProviders[row.proveedor_id].direccion || ""
                          }
                          onChange={(e) =>
                            handleInputChange(e, "direccion", row)
                          }
                          className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                      </div>
