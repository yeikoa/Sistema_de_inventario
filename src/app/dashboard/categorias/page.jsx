    ...
    return (
        <div className='container mx-auto p-4'>
            ...
            <div className="mb-4 flex flex-col gap-2 w-full md:w-1/2">
                ...
                >
                    {categoriaActiva.categoria_id ? <><FaSyncAlt /> Actualizar</> : <><FaPlusCircle /> Agregar</>}
                </button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {categorias.map((categoria) => (
                    <div key={categoria.categoria_id} 
                         ...
                         onMouseEnter={(e) => e.currentTarget.classList.add('ring', 'ring-cyan-900')}
                         onMouseLeave={(e) => e.currentTarget.classList.remove('ring', 'ring-cyan-900')}>
